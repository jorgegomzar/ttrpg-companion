    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          Para jugar es necesario poseer el <a className="underline decoration-dashed" href="https://www.elrefugioeditorial.com/un-vampiro-de-mil-anos"><b>JUEGO ORIGINAL</b></a>
        </HubCard>
